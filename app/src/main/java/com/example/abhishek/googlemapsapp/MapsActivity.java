...
//        startService(i);
    ...
    private Geofence getGeofence() {
        LatLng latLng = Constants.AREA_LANDMARKS.get(Constants.GEOFENCE_ID_MY_HOME);
        return new Geofence.Builder()
                .setRequestId(Constants.GEOFENCE_ID_MY_HOME)
...
//        googleApiClient.disconnect();
    ...
    public void onMapReady(GoogleMap mMap) {
        ...
        googleMap = mMap;
        LatLng latLng = Constants.AREA_LANDMARKS.get(Constants.GEOFENCE_ID_MY_HOME);
        mMap.addMarker(new MarkerOptions().position(latLng).title("Stanford University"));
